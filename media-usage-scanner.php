 ...
 * Description: Comprehensive media library scanner with reverse-index engine, duplicate detection, optional ZIP backups with selective one-click restore, CSV export, scheduled scans, WP-CLI, and intelligent usage detection across Elementor, WooCommerce, ACF (including ID-only return format fields), widgets, menus, theme mods, and more.
 * Version:     2.8.0
