 ...
 * Description: Comprehensive media library scanner with reverse-index engine, duplicate detection, one-click backup restore, ZIP/CSV export, scheduled scans, WP-CLI, and intelligent usage detection across Elementor, WooCommerce, ACF (including ID-only return format fields), widgets, menus, theme mods, and more.
 * Version:     2.5.0
